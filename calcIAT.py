'''
Updates for 2020 by Sonny Parlin, search text for #thpii
...
for filename in files:
    ...
    df = pd.read_csv(filename, skiprows=1) #thpii added skiprows to skip row 1 of each file.
    print(df)
    ...
    #thpii line 103 is where the test flips, so instead of using an order variable I see what line of the file we're on
    if i < 103:
